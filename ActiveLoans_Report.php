		...
		<div class="card">
			<div class="card-body">
				...
				<div style="color:#009900; text-align: center;"><div style="font-size:15px"><div style="align:center" >Loan Management System for Ojukua Small Micro Finance Capital limited </div></div></div>
					<small class="pull-left"><div style="color:#009900">All list Active details</div></small>
				...
				<table class="table table-bordered" id="loan-list">
                        ...
                        <div>
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-3">
                                        <div class="text-white-75 small"><b>Active Loans</b></div>
					...
					<tbody>
						<?php
							...
							$qry = $conn->query("SELECT l.*,concat(b.lastname,', ',b.firstname,' ',b.middlename)as name, b.contact_no, b.address from loan_list l inner join borrowers b on b.id = l.borrower_id where status=2  order by id asc");
