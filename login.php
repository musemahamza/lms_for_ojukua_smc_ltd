...
<body>
  ...
  <main id="main" class=" bg-info">
  	...
  	<h1> <span class="title">Ojukua SMC Capital Limited<span></h>
  		

  		<div id="login-right" class="center">
  			<div class="card col-md-8 bg-info">
  				<div class="card-body">
					<img src="uploads/LMS.png" width="250" height="250" class="center">
  						<!-- <div class="logo">
