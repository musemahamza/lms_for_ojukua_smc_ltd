	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				...
				<a href="BorrowerList_Report.php" target="_blank" class="btn btn-primary btn-flat"><i class="fa fa-print"></i>&nbsp;Print</a>
						...
						$i = 1;
						 ...
						 <tr>
						 	...
						 	<td>
						 		...
						 		<p><large>Tax ID :<b><?php echo $row['tax_id'] ?></small></b></p>
								<p style="color:skyblue;"><large><b>Guarantor's Info</small></b></p>
